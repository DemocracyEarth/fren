const { loadEnv, defaultDataDir } = require('./env');
loadEnv();
const path = require('path');

// Where FREN keeps its files: see env.js (the same folder holds the packaged
// app's .env, so the loader owns the definition).
