 ...
 */
export const TONE = {
  base:    { color: 0xffa200, rough: 0.34, sheen: 0.40 },
  warm:    { color: 0xffa914, rough: 0.28, sheen: 0.55 },   // brighter AND more vivid
  excited: { color: 0xffad1f, rough: 0.20, sheen: 0.75 },   // glossier: catches more light
