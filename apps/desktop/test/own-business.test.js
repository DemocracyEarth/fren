...
const MUST = {
  ...
  'watch:true': [
    ...
    'you can watch again', 'unpause', 'wake up', 'turn your light back on', 'look again',
  ],
  running: [
  ...
  'include': [
    ...
    'unexclude example.com', 'start reading this site again',
  ],
  'readPages:false': ['stop reading pages', 'stop reading my pages', 'stop reading web pages'],
  ...
  colour: [
    ...
    'reset your colour', 'what colours can you be',
  ],
  'wakeOnLaunch:false': [
  ...
  'volunteer:false': [
    'stop interrupting me', 'stop interrupting', "don't interrupt me", "don't speak unless I talk to you",
  ...
  remember: [
    ...
    'please remember that I work from home on Fridays',
  ],
  knows: [
...
const MUST_NOT = [
  ...
  'make your colour purple', 'what is your favourite colour', 'change the colour of the header to blue',
